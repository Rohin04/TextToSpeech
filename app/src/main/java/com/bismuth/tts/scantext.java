...
public class scantext extends AppCompatActivity {
    ...
    private Button dictatescan;
    private TextToSpeech mTTs;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scantext);
        ...
        dictatescan = findViewById(R.id.dictatescanbtn);
        dictatescan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             final  String dic =  scanResults.getText().toString();

                mTTs.setPitch(10/50);
                mTTs.setSpeechRate(10/50);
                mTTs.speak(dic, TextToSpeech.QUEUE_FLUSH,null);
